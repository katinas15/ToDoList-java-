...
import Exceptions.ObjectNotExists;
...
public class TasksController implements Initializable {
    ...
    private void showAllProjects(){
        ...
        for(Company c:userHibernateController.findUser(selectedUser.getId()).getCompanies()){
            for(Project p:c.getProjects()){
                boolean same = false;
                for(Project pu:userHibernateController.findUser(selectedUser.getId()).getAllProjects()){
    ...
    public void loadProjectUsers() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../FXML/projectUsers.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
